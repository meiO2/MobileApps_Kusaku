...
from .views import SendOTPView, RegisterView, LoginView, ProfileDetailView, ChangePasswordView, ChangeTransactionPinView, VerifyOTPView, ResetPasswordView, SendForgotPasswordOTPView, UpdateProfileView
